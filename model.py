...
class Brand(db.Model):
    ...
    def __repr__(self):
        """Show info about a brand."""

        return '<Brand brand_id={} name={} founded={} discontinued={}>'.format(self.brand_id, self.name, self.founded, self.discontinued)
...
class Model(db.Model):
    ...
    def __repr__(self):
        ...
        return '<Model id={} year={} brand={} name={}>'.format(self.model_id, self.year, self. brand_id, self.name)
